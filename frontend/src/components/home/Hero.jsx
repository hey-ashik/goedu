...
export default function Hero() {
  ...
  return (
    <section aria-labelledby="hero-new-heading" className="hero-section relative z-30 w-full bg-[#FFF6DD] dark:bg-gray-900 flex flex-col mt-[4.5rem] lg:mt-0 lg:pt-20">
